...
QUESTIONS = {
    ...
    SECRET_SHAPED: {
        ...
        "instructions": {
            ...
            "credential_types": ["API key or access token", "password or passphrase", "private key",
...
LABELS = {
    MESSAGE_IS_SUBSTANTIVE: "message is substantive",
    MESSAGE_MATCHES_DIFF: "message matches diff",
